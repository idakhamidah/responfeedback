...
/*
  ...
  */  //exit;
    ...
    if(isset($id_tweet)){
      ...
      if($cek_tweet>0){
        //ada proses identifikasinya
          $tweet_bersih=pre_processing(array('tweet'=>$text_tweet)); //preprocessing
         ...
         if($tweet_bersih!=""){ //jika bukan RT
            ...
            foreach($data_testing as $i=>$tt) {
                ...
                //                  3=>$prior[1]['prior'],
                //                  4=>$prior[3]['prior']);
                $score[$i]=array(1=>$prior[0]['prior'], // unknown
                                 2=>$prior[3]['prior'], // pujian
            ...
            //tweet bersih kosong
            echo "Tweet hasil preprocessing kosong";
         }
    ...
    function klasifikasi_rocchio($kata_d=array()){ 
      ...
      while($c=mysql_fetch_array($sql_centroid)){
        //ngecek klo kata uji sudah ada di data traning
